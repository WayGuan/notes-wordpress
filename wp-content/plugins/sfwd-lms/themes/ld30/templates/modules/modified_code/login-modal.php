	...
	<div class="ld-login-modal-login">
		<div class="ld-login-modal-wrapper">
			...
			<div class="ld-login-modal-form">
				...
				$lost_password_url = str_replace('/blogs/blogs', '/blogs', $lost_password_url);
				// Sanitize 'redirect_to' to remove special characters
				$redirect_url = remove_query_arg( 'ld-resetpw', get_permalink() );
				$redirect_url = rawurlencode( $redirect_url );

				// Add the cleaned 'redirect_to' back to the lost password URL

				$lost_password_url = add_query_arg( 'redirect_to', $redirect_url, $lost_password_url );
