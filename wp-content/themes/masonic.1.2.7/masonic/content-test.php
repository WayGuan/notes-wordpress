...
if(isset($_POST['submit_space'])){
  ...
  if(isset($_POST['submit_3D_printer']) || isset($_POST['submit_carvey'])){
  ...
  <div class="entry-content">
    ...
    <div id="formOne" style="display: block;">
          <div class="entry-content">
            ...
            <form action="/shareit/test<?php if(!empty($choice)) echo '?choice=' . $choice; ?>" method="post" enctype="multipart/form-data" onsubmit="return validateBooking_space();">     
                <fieldset>
    ...
    <div id="formTwo" style="display: none;">
       <div class="entry-content" id="form-entry-div">
        ...
        <form action="/shareit/test<?php if(!empty($choice)) echo '?choice=' . $choice; ?>" method="post" enctype="multipart/form-data" onsubmit="return validateBooking_equip();">     
            <fieldset>
              <p><strong>All fields with * are required.</strong></p>
              ...
              <p> 
               <input type="text" name="lab_library_card_equip" class="input_space" id="lab_library_card_equip" value="<?php echo $lab_library_card_equip; ?>" required />
              </p>
         
              <p> <label for="lab_email_equip" class="label_text">Email<sup>*</sup>:&nbsp;</label></p>
              <p> 
                <input type="email" name="lab_email_equip" class="input_space" id="lab_email_equip" value="<?php echo $lab_email_equip; ?>" size="50" required />
              </p>
    ...
    <!-- =========================================   Content : book a service ================================================================== -->
        ...
        <div class="entry-content">
          ...
          <form action="/shareit/test<?php if(!empty($choice)) echo '?choice=' . $choice; ?>" method="post" enctype="multipart/form-data" onsubmit="return validateBooking_service();">     
                <fieldset>
                  <p><strong>All fields with * are required.</strong></p>
                  ...
                  <p>
                    <input type="text" name="lab_first_name_service" class="input_space" id="lab_first_name_service" value="<?php echo $first_name_service; ?>" size="50" required />
                  </p>

                  <p> <label for="lab_last_name_service" class="label_text">Last Name<sup>*</sup>:&nbsp;</label> </p>
                  <p>
                      <input type="text" name="lab_last_name_service" class="input_space" id="lab_last_name_service" size="50" value="<?php echo $last_name_service; ?>" required />
                  </p>
                  ...
                  <p>
                      <input type="text" name="lab_library_card_service" class="input_space" id="lab_library_card_service" value="<?php echo $lab_library_card_service; ?>" required />
                  </p>
             
                  <p> <label for="lab_email_service" class="label_text">Email<sup>*</sup>:&nbsp;</label> </p>
                  <p>
                    <input type="email" name="lab_email_service" class="input_space" id="lab_email_service" size="50" value="<?php echo $lab_email_service; ?>" required />
                  </p>
          ...
          <form action="/shareit/test<?php if(!empty($choice)) echo '?choice=' . $choice; ?>" method="post" enctype="multipart/form-data" onsubmit="return validateBooking_service();">     
                <fieldset>
                  ...
                  <p id="p_carvey_link_field"> <label for="lab_carvey_link_service" class="label_text">Carvey: Add Easel Editor Link:&nbsp;</label><br/>
                   <input type="text" name="lab_carvey_link_service" class="input_space" id="lab_carvey_link_service" value="<?php echo $lab_carvey_link; ?>" size="50" />
                  </p>
