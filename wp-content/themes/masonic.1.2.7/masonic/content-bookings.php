...
$list_of_materials = array(
  "plywood_8x8_1x4" => "Plywood (8x8 1/4in Thickness)",
  "plywood_8x12_1x4" => "Plywood (8x12 1/4in Thickness)",
  "MDF_8x12" => "MDF (8x12)",
...
$list_of_glowforge_materials = array(
  "plywood_11x19_1x8" => "Plywood (11x19 1/8in Thickness)",
  "plywood_11x19_1x4" => "Plywood (11x19 1/4in Thickness)",
  "Clear_Acrylic_8x12_1x8" => "Clear Acrylic (8x12 1/8in Thickness)",
  "Clear_Acrylic_12x20_1x8" => "Clear Acrylic (12x20 1/8in Thickness)",
  "use_my_own_material" => "Use My Own Material"
);     
...
foreach($all_labs as $each_lab){
    ...
    if($each_lab->branch_id == 2){
        $special_list['2'][$each_lab->type][$each_lab->short_name] = $each_lab->full_name;
    }        
}
...
if(isset($_POST['submit_space'])){
    ...
    if(strlen($results) == 0){
      ...
      //$number = preg_replace("/[^\d]/","",$lab_telephone_space);
      //$lab_telephone_space = preg_replace("/^1?(\d{3})(\d{3})(\d{4})$/", "($1) $2-$3", $number);
      ...
      /*"Purpose:  ". $lab_purpose . "\n\n".*/
      "Phone Number:  ". $lab_telephone_space . "\n\n".
      "Library Card Number:  ". $lab_library_card_space . "\n\n".
      "Email Address:  ". $lab_email_space . "\n\n".
      "Space:  ". $labs[$lab_name_space] . "\n\n".
      "Preferred Date:  ". $lab_date_space . "\n\n".
      "Preferred Time Slot:  ". $time_options[$lab_time_slot_space] . "\n\n";      
      ...
      $mail->Body = $message;
      $mail->AddAddress( $to );  
      $mail->AddCC('vplwebmaster@vaughan.ca');   
      $mailSuccess = $mail->Send();
      //$mailSuccess = true;

      if ($mailSuccess)
      {
          $lab_success = "We thank you for your interest in booking one of Vaughan Public Library's Creation Spaces, we are excited and honoured that our services are rising in popularity and as such have seen an increase in bookings, please wait for your email confirmation of booking. If your selected reservation date/time is unavailable, our staff will be in touch with alternative booking options. Thank you for your patience and understanding.";  
          insertStatsData(52);  
  ...
  if(isset($_POST['submit_equip'])){
    ...
    if(strlen($results) == 0){
      ...
      //$number = preg_replace("/[^\d]/","",$lab_telephone_equip);
      //$lab_telephone_equip = preg_replace("/^1?(\d{3})(\d{3})(\d{4})$/", "($1) $2-$3", $number);   
      ...
      /*"Purpose:  ". $lab_purpose . "\n\n".*/
      "Phone Number:  ". $lab_telephone_equip . "\n\n".
      "Library Card Number:  ". $lab_library_card_equip . "\n\n".
      "Email Address:  ". $lab_email_equip . "\n\n".
      "Equipment:  ". $labs[$lab_name_equip] . "\n\n".
      "Preferred Date:  ". $lab_date_equip . "\n\n".
      "Preferred Time Slot:  ". $timeslot_options[$lab_time_slot_equip] . "\n\n";
  ...
  if(isset($_POST['submit_3D_printer']) || isset($_POST['submit_carvey']) || isset($_POST['submit_glowforge']) || isset($_POST['submit_smilebutton'])){
      ...
      elseif (isset($_POST['submit_carvey']))
      {
          $lab_name_service = "carvey";
      } 
      elseif (isset($_POST['submit_glowforge']))
      {
          $lab_name_service = "Glowforge";
      }         
      else
      {
          if($branch_service == 2)
          {
              $lab_name_service =  "smilebutton_1";
          }
          elseif ($branch_service == 7) {
              $lab_name_service = "smilebutton_2";
          }
          elseif ($branch_service == 11) {
              $lab_name_service = "smilebutton_3";
          }
      }
      ...
      $lab_date_carving = "";
      if(isset($_POST['lab_date_carving'])){
         $lab_date_carving = filter_var($_POST['lab_date_carving'], FILTER_SANITIZE_STRING);
      }
      ...
      if(isset($_POST['lab_time_carving']))
         $lab_time_carving = filter_var($_POST['lab_time_carving'], FILTER_SANITIZE_STRING);              
      ...
      if($branch_service == "2"){
        $branch_name = "Bathurst Clark Resource Library";
        $branch_short = "BCRL";
      }
      ...
      if(strlen($results) == 0){
        ...
        if (!isset($_POST['submit_smilebutton'])) {
          $message .= "Age: ". $lab_age_service . "\n\n".
        ...
        /*"Purpose: ". $lab_purpose . "\n\n".*/
        //$number = preg_replace("/[^\d]/","",$lab_telephone_service);
        //$lab_telephone_service = preg_replace("/^1?(\d{3})(\d{3})(\d{4})$/", "($1) $2-$3", $number);

        $message .= "Phone Number: ". $lab_telephone_service . "\n\n".
        ...
        if(!empty($lab_date_service) && !empty($lab_time_service))
        {
           ...
           $message .= "Timeslot: " . $timeslot_options[$lab_time_service] . "\n\n";
        }

        if(!empty($lab_date_carving) && !empty($lab_time_carving))
        {
           $message .= "Date: " . $lab_date_carving . "\n\n";

           $message .= "Timeslot: " . $timeslot_options[$lab_time_carving] . "\n\n";
        }
        ...
        if(!empty($lab_filament_colour) && strpos($lab_name_service, "carvey") === false && strpos($lab_name_service, "Glowforge") === false){
        ...
        if(strpos($lab_name_service, "Glowforge") !== false){        
          $lab_material = filter_var($_POST['lab_material_service'], FILTER_SANITIZE_STRING);
          $material_name = $list_of_glowforge_materials[$lab_material];
        ...
        if(!empty($lab_carvey_link) && strpos($lab_name_service, "Glowforge") !== false){                
          $message .= "Glowforge Link: ". $lab_carvey_link . "\n\n";
        }  
...
function validate_booking_space($lab_first_name, $lab_last_name, $lab_age, $lab_purpose, $lab_waiver, $lab_card, $lab_phone, $lab_email, $lab_orientation, $lab_time, $lab_date, $lab_name, $lab_branch){
  ...
  if (!empty($lab_phone))
  {
    $number = preg_replace("/[^\d]/","",$lab_phone);
...
function validate_booking_service($lab_first_name, $lab_last_name, $lab_age, $lab_purpose, $lab_waiver, $lab_certification, $lab_card, $lab_phone, $lab_email, $lab_orientation, $lab_name, $lab_branch, $file_location_name, $file_error, $file_size){
  ...
  if(!empty($file_location_name) && 
      strpos($file_location_name, ".jpg") === false && 
      strpos($file_location_name, ".jpeg") === false && 
      strpos($file_location_name, ".png") === false && 
      strpos($file_location_name, ".pdf") === false && 
      strpos($file_location_name, ".svg") === false)
  {
      $str_message .= "The file type must be JPEG, PNG, PDF or SVG.\n" . "<br/>";
  }  
...
<article id="post-<?php the_ID(); ?>" <?php post_class('blog-post'); ?>>
  ...
  <div class="entry-content">
      ...
      #selectOption {
        border-bottom: 2px #dff0d8 solid; 
      }
    ...
    <div id="selectOption">  
          <div>
            ...
            <div style="background-color: #dff0d8; border-color: #dff0d8; padding: 10px, 10px, 10px, 10px;">
                <p style="color:blue;"><strong>Service Update:</strong>  We are pleased to announce the re-opening of our creation spaces. Some services may not be available due to public health guidelines.</p>
            </div>
            <div>&nbsp;</div>        
            <div>&nbsp;</div>-->
          </div>
          <div><p>Select from the options below to request a booking for any of our maker spaces and services. Requirements include a valid <a style="text-decoration:underline;" href="https://www.vaughanpl.info/services/membership/">Library Card</a> and completion of the <a style="text-decoration:underline;" href="/blogs/wp-content/uploads/sites/2/creation_spaces_customer_agreement.pdf">Customer Agreement Form</a>. After submitting the form, staff will review the request and send you a confirmation email.</p></div>        
 
          <SECTION id="sec_rb_one">
              <div>
                <a id="space_tab">
                  <input class="rb_type_one" type="radio" id="rb_space" name="select" value="1" onclick="changeForms()" checked>
                  <label class="rb_label" for="rb_space" id="rb_label_space">
                      <p>Photo & Video /<br> Recording<br>Studios</p>
                      <p class="rb_branch_one">Civic Centre Resource Library</p>
                      <img class="img-responsive card_image alignnone card_img" src="/blogs/wp-content/uploads/sites/2/Customers-using-Music-Recording-Studio.png" alt="Recording Studio" width="203">
                      <p class="rb_para">
                          Book time to independently create your project and use our editing software. 
                          <!--Please note that the Green Screen Studio and Recording Studio are still closed for booking at this time due to maintenance and health restrictions. This notice will be changed soon and this site will be updated as these services become available to be booked, thank you for your patience and understanding.-->
                      </p>
                  </label>
                </a>
              </div>
             ...
             <div>
              <a id="printer_tab">
                  ...
                  <label class="rb_label" for="rb_3d_printer" id="rb_label_print">
                      <p>3D Printing</p>
                      <p class="rb_branch_one">Civic Centre Resource Library</p>
                      <p class="rb_branch">Pierre Berton Resource Library</p>
                      <img class="img-responsive card_image card_img" src="/blogs/wp-content/uploads/sites/2/wp-content/uploads/New-3D-Printer-@PBRL.jpg" alt="New 3D Printer" width="203">
                      <p class="rb_para">
          ...
          <SECTION id="sec_rb_two">
               ...
               <div>
                  ...
                  <label class="rb_label" for="rb_carving" id="rb_label_carving">
                      <p>Carving</p>
                      <p class="rb_branch_one">Pierre Berton Resource Library</p>
                      <img class="img-responsive card_image card_img" src="/blogs/wp-content/uploads/sites/2/Carving.jpg" alt="New 3D Printer" width="203">
                      <p class="rb_para">
                         Free service for VPL cardholder. Staff will Engrave or Cut your design into wood or plastic using our Carvey machine. Only staff have access to the machine.
                      </p>
                  </label>
              </div>

             <div>
                  <input class="rb_type_one" type="radio" id="rb_glowforge" name="select" value="5" onclick="changeForms()">
                  <label class="rb_label" for="rb_glowforge" id="rb_label_glow">
                      <p>Glowforge<br>Laser Cutter/<br>Engraver</p>
                      <p class="rb_branch_one">Pierre Berton Resource Library</p>
                      <img class="img-responsive card_image card_img" src="/blogs/wp-content/uploads/sites/2/Glowforge-Product-Hero-Plus.png" alt="Glowforge" width="203">
                      <p class="rb_para">
                          Free service for VPL cardholder. Staff will <strong>Engrave</strong>, <strong>Score</strong>, or <strong>Cut</strong> your design into wood or plastic using our Glowforge Plus machine. Only staff have access to the machine. 
                      </p>
                  </label>
              </div>            
          </SECTION>
          <SECTION id="sec_rb_three">

             <div>
                  <input class="rb_type_one" type="radio" id="rb_equipment" name="select" value="2" onclick="changeForms()">
                  <label class="rb_label" for="rb_equipment" id="rb_label_equip">
                      <p>Other<br>Equipment</p>
                      <!--<p class="rb_branch_one">Civic Centre Resource Library</p>-->
                      <p class="rb_branch">Pierre Berton Resource Library</p>
                      <img class="img-responsive card_image card_img" src="/blogs/wp-content/uploads/sites/2/Oculus-Rift-1.png" alt="Oculus-Rift" width="203">
                      <p class="rb_para">
               ...
               <div style="display:none;">
                  <input class="rb_type_one" type="radio" id="rb_smilebutton" name="select" value="6" onclick="changeForms()">
              </div>
          </SECTION>
    <br />
    <p><img src="/img/vpl_at_home/icon-pdf.gif" alt="PDF">
          <a href="/blogs/wp-content/uploads/sites/2/creation_spaces_customer_agreement.pdf" rel="external" target="_blank">Download Customer Agreement Form</a>
    </p> 
      </div>
    <!-- =========================================   Radio Button Selections ================================================================== -->
    ...
    <div id="formOne" style="display: block;"> 
          <!--new added v v -->
          <div class="entry-content">  
            <h2>Photo & Video Studio and Recording Studio</h2>
            <p>Civic Centre Resource Library</p>
            <div class="description">
              <div>&nbsp;</div>
              <!--<p class="disclaimer">Disclaimer: At this point in time the recording studio and green screen studio are not yet available to be booked due to health restrictions and distancing guidelines.</p>-->
              <p>Please be aware that the Create It Studio spaces are learning spaces and are not soundproofed. Noise bleed from adjoining rooms may interfere with your booking.</p>
              <p>If you are feeling unwell the day of or prior to your booking please contact us and we will be more than happy to help reschedule your session.</p>
            </div>
          </div>
          <!--new added ^ ^-->
          <div class="entry-content"> <!--Remove display: none-->
            <!-- <?php if(strlen($lab_message) > 0){ ?>
              <div class="notify-margin notify notify-red">Form Submission Error:<br><?php echo $lab_message; ?></div>
            <?php }else if(strlen($lab_success) > 0){ ?>
              <div class="notify-margin notify notify-green"><?php echo $lab_success; ?></div>
            ...
            <div class="description"> 
             ...
             <!--  <p>Vaughan Public Libraries cardholders can book the Green Room or Recording Studio at the <a href="http://www.vaughanpl.info/libraries/view/11" target="_blank">Civic Centre Resource Library</a> for free.</p> -->
              ...
              <ul>
              <li>Print and complete the Customer Agreement Form and return it on your first booking <a href="/blogs/wp-content/uploads/sites/2/creation_spaces_customer_agreement.pdf" target="_blank">Download Customer Agreement Form</a>.</li>
            ...
            <form action="/blogs/shareit/bookings<?php if(!empty($choice)) echo '?choice=' . $choice; ?>" method="post" enctype="multipart/form-data" onsubmit="return validateBooking_space();">     
                <fieldset>
                  ...
                  <p>
                    <select class="select_no_dropdown" name="branch_space" title="Local Branch" id="branch_space" onchange="changeLabs_space()" required>              
                  ...
                  <p><label for="lab_date_space" class="label_text">Preferred Date<sup>*</sup>:&nbsp;</label></p>
                  <p>
                  ...
                  <p><label for="lab_time_space" class="label_text">Preferred Time Slot<sup>*</sup>:&nbsp;</label></p>
                  <p>
                    <select name="lab_time_space" id="lab_time_space" required>
                      <option value="">- Select Space and Date -</option>
                    </select>              
                  </p>
                  <p><em>The dates and times shown on this booking form do not indicate availability of rooms and equipment. After submitting this form, please wait for a confirmation email from our staff to complete your booking.</em></p>
                  ...
                  <p><label for="lab_library_card_space" class="label_text">Library Card Number<sup>*</sup>:&nbsp;</label></p>
                  <p>
                  ...
                  <p><label for="lab_telephone_space" class="label_text">Phone Number<sup>*</sup>:&nbsp;</label></p>
                  <p>
                    <input type="text" name="lab_telephone_space" id="lab_telephone_space" class="input_space" placeholder="(416) 123-4567" onkeyup="formatPhone(this)" value="<?php echo $lab_telephone_space; ?>" required />
                  </p>
    ...
    <div id="formTwo" style="display: none;">
       <div class="entry-content" id="form-entry-div">
        ...
        <?php //the_content(); ?> -->
        <h2>Equipment</h2>
        <p>Pierre Berton Resource Library</p>
        <div class="description">
          
            <div>&nbsp;</div>
            <p>Vaughan Public Libraries cardholders can book time to use equipment independently in the <a href="http://www.vaughanpl.info/libraries/view/7" target="_blank">Pierre Berton</a> Resource Libraries.</p>
            ...
            <li>All users of the Oculus Rift must be at least 13 years of age and must read and adhere to all <a href="/blogs/wp-content/uploads/sites/2/health_and_safety_rules_and_guidelines.pdf" target="_blank">Health &amp; Safety Guidelines</a>.</li>
        ...
        <form action="/blogs/shareit/bookings<?php if(!empty($choice)) echo '?choice=' . $choice; ?>" method="post" enctype="multipart/form-data" onsubmit="return validateBooking_equip();">     
            <fieldset>
              <p><strong>All fields with * are required.</strong></p>
              ...
              <p> 
                <select name="branch_equip" class="select_no_dropdown" title="Local Branch" id="branch_equip" onchange="changeLabs_equip()" required>              
              ...
              <p> <label for="lab_date_equip" class="label_text">Preferred Date<sup>*</sup>:&nbsp;</label></p>
              <p> 
              ...
              <p> <label for="lab_time_equip" class="label_text">Preferred Time Slot<sup>*</sup>:&nbsp;</label></p>
              <p>
              ...
              <!-- <p> <label for="lab_purpose_equip" class="label_text">Purpose<sup>*</sup>:&nbsp;</label></p>
              <p> 
                <select name="lab_purpose_equip" id="lab_purpose_equip" required>
                  <option value=""> </option>
              ...
              <p> <label for="lab_library_card_equip" class="label_text">Library Card Number<sup>*</sup>:&nbsp;</label></p>
              <p> 
              ...
              <p> <label for="lab_telephone_equip" class="label_text">Phone Number<sup>*</sup>:&nbsp;</label></p>
              <p> 
                <input type="text" name="lab_telephone_equip" class="input_space" id="lab_telephone_equip" placeholder="(416) 123-4567" onkeyup="formatPhone(this)" value="<?php echo $lab_telephone_equip; ?>" required />
              </p>
              <!--<p style="color: darkblue;"><strong>The format of phone number should be (416) 123-4567.</strong></p>-->
    ...
    <!-- =========================================   Content : book a service ================================================================== -->
        ...
        <div class="entry-content">
          <h2>3D Printing</h2>
          <p>Civic Centre Resource Library<br>
          ...
          <div class="description">
            ...
            <ul>
            <li>Print and complete the Customer Agreement Form and return it on your first booking.&nbsp;<a href="/blogs/wp-content/uploads/sites/2/creation_spaces_customer_agreement.pdf">Download Customer Agreement Form</a>.</li>
            <li style="font-weight: inherit;">Become 3D Certified by taking VPL&rsquo;s online <a title="3D Certification Course" href="http://www.vaughanpl.info/blogs/shareit/courses/get-certified-online/" target="_blank">3D Certification Course</a></li>
          ...
          <form action="/blogs/shareit/bookings<?php if(!empty($choice)) echo '?choice=' . $choice; ?>" method="post" enctype="multipart/form-data" onsubmit="return validateBooking_service();">     
                <fieldset>
                  <p><strong>All fields with * are required.</strong></p>
                  ...
                  <p> 
                      <select name="branch_service" title="Local Branch" id="branch_service" required> <!-- onchange="changeLabs_service()" -->              
                  ...
                  <p><label for="lab_date_service" class="label_text">Preferred Date<sup>*</sup>:&nbsp;</label></p>
                    <p>
                    ...
                    <p><label for="lab_time_service" class="label_text">Preferred Time Slot<sup>*</sup>:&nbsp;</label></p>
                    <p>
                  ...
                  <p> <label for="lab_library_card_service" class="label_text">Library Card Number<sup>*</sup>:&nbsp;</label> </p>
                  <p>
                  ...
                  <p> <label for="lab_telephone_service" class="label_text">Phone Number<sup>*</sup>:&nbsp;</label> </p>
                  <p>
                      <input type="text" name="lab_telephone_service" class="input_space" id="lab_telephone_service" placeholder="(416) 123-4567" onkeyup="formatPhone(this)" value="<?php echo $lab_telephone_service; ?>" required />
                  </p>
                  <!--<p style="color: darkblue;"><strong>The format of phone number should be (416) 123-4567.</strong></p>-->

                   <!-- <p id="p_supports_required"> <label for="lab_supports_required_service" class="label_text">Supports required?<sup>*</sup>:&nbsp;</label><br/>           
                    <input type="radio" id="lab_supports_required_service" value="Yes" class="show_radio" name="lab_supports_required_service"
                    <?php echo ($lab_supports_required == "Yes") ? "checked" : ""; ?>>&nbsp;Yes
                    <input type="radio" id="lab_supports_required_service" value="No" class="show_radio" name="lab_supports_required_service" <?php echo (empty($lab_supports_required) || $lab_supports_required == "No") ? "checked" : ""; ?>>&nbsp;No                              
                  </p> -->

                  <!--  <p id="p_comment"> <label for="lab_comment_service" class="label_text">Comments / Instructions<sup></sup></label><br/> 
                      <textarea id="lab_comment_service" name="lab_comment_service" rows="3" cols="50"><?php echo $lab_comment; ?></textarea>
                    </p> -->
      ...
      <div id="formFour" style="display: none;">
        <div class="entry-content">
          <h2>Carving</h2>
          <p>Pierre Berton Resource Library
          </p>          
          <div class="description">
            <div>&nbsp;</div>
                <p><strong>Fees</strong></p>
                <p>Carvey: Free service. Only Material Cost if you want to use the library material. You can use your own material based on <a href="http://www.vaughanpl.info/blogs/shareit/guidelines-for-materials-used-with-carvey/" target="_blank">the Material Guideline</a>.</p>
                ...
                <tr>
                <!--<td width="274">Plywood</td>
                <td width="69">8 x 8</td>
                <td width="105">1/4</td>
                <td width="117">$1.50</td>
                </tr>-->
                <tr>
                <td width="274">Plywood</td>
                <td width="69">8 x 12</td>
                <td width="105">1/4</td>
                <td width="117">$2.50</td>
                </tr>
                <!--<tr>
                <td width="274">Plywood</td>
                <td width="69">8 x 8</td>
                ...
                <ul>
                    ...
                    <li>Print and sign a <a href="/blogs/wp-content/uploads/sites/2/creation_spaces_customer_agreement.pdf" target="_blank">Customer Agreement Form</a> and return it on your first booking.</li>
                    <li>Read the rules and guidelines below:</li>
                    <ul>
                      <li>Bookings must be made at least 3 days in advance.</li>
          ...
          <form action="/blogs/shareit/bookings<?php if(!empty($choice)) echo '?choice=' . $choice; ?>" method="post" enctype="multipart/form-data" onsubmit="return validateBooking_service();">     
                <fieldset>
                  ...
                  <p> <label for="lab_branch_service" class="label_text">Branch<sup>*</sup>:&nbsp;</label></p>
                  <p> 
                      <select class="select_no_dropdown" name="branch_service" title="Local Branch" id="branch_service" required>  <!-- onchange="changeLabs_service()" -->            
                          <!-- <option value="11" <?php if($branch_service == "11") echo "selected"; ?>>Civic Centre Resource Library</option> -->
                          <option value="7">Pierre Berton Resource Library</option>
                      </select>
                  </p>

                  <!--<p><label for="lab_date_carving" class="label_text">Date<sup>*</sup>:&nbsp;</label></p>
                    <p>
                      <input name="lab_date_carving" size="50" maxlength="15" class="input_space" value="<?php echo $lab_date_carving; ?>" onblur="limitTime_carving()" id="lab_date_carving"  type="text" required>
                    </p>

                    <p><label for="lab_time_carving" class="label_text">Time Slot<sup>*</sup>:&nbsp;</label></p>
                    <p>
                      <select name="lab_time_carving" id="lab_time_carving" required>
                        <option value="">- Select Time Slot -</option>
                      </select>              
                    </p>-->                 
                  ...
                  <p id="p_material"> <label for="lab_material_service" class="label_text">Material<sup>*</sup>:&nbsp;</label><br/>
                    <select name="lab_material_service" id="lab_material_service" required>
                      ...
                      <!--<option value="plywood_8x8_1x4" <?php echo (empty($lab_material) || ($lab_material == "plywood_8x8_1x4")) ? "selected" : ""; ?>>Plywood (8x8 1/4in Thickness)</option>-->                     
                      <option value="plywood_8x12_1x4" <?php echo ($lab_material == "plywood_8x12_1x4") ? "selected" : ""; ?>>Plywood (8x12 1/4in Thickness)</option>
      ...
      <div id="formFive" style="display: none;">
	<p style="margin-top: 20px; font-size: 1.6em; color: #000; text-align: center; display: none;"><strong>Temporary Out of Service!<strong></strong></strong></p>
        <div class="entry-content">
          <h2>Glowforge Laser Cutter/Engraver</h2>
          <p>Pierre Berton Resource Library
          </p>          
          <div class="description">
            <div>&nbsp;</div>
                <p><strong>Fees</strong></p>
                <p>Glowforge Plus: Free service. Only Material Cost if you want to use the library material. You can use your own material based on <a href="http://www.vaughanpl.info/blogs/shareit/guidelines-for-materials-used-with-carvey/" target="_blank">the Material Guideline</a>.</p>
                <p><span id="id8998" class="collapseomatic colomat-close colomat-visited colomat-hover" tabindex="0" title="Material Cost Information">Material Cost Information</span></p>
                <div id="target-id8998" class="collapseomatic_content ">
                <table width="565">
                <tbody>
                <tr>
                <td width="74"><strong>Material</strong></td>
                <td width="269"><strong>Size (in)</strong></td>
                <td width="105"><strong>Thickness (in)</strong></td>
                <td width="117"><strong>Cost (C$)</strong></td>
                </tr>
                <!--<tr>
                <td width="74">Plywood</td>
                <td width="269">8 x 8</td>
                <td width="105">1/4</td>
                <td width="117">$1.50</td>
                </tr-->
                <!--<tr>
                <td width="74">Plywood</td>
                <td width="269">11 X 19 (working area: 10.75 by 19 inches)</td>
                <td width="105">1/8</td>
                <td width="117">$3.00</td>
                </tr>-->
                <tr>
                <td width="74">Plywood</td>
                <td width="269">11 X 19 (working area: 10.75 by 19 inches)</td>
                ...
                <tr>
                <td width="74">Clear Acrylic</td>
                <td width="269">8 x 12</td>
                <td width="105">1/8</td>
                <td width="117">$3.50</td>
                </tr>  
                <tr>
                <td width="74">Clear Acrylic</td>
                <td width="269">12 x 20 (working area: 10.75 by 19 inches)</td>
                <td width="105">1/8</td>
                <td width="117">$8.50</td>
                </tr>                                   
                </tbody>
                </table>
                </div>
                <p><strong>To book a staff member to work on your design:</strong></p>
                <ul>
                    <li>Have a valid VPL card in good standing.</li>
                    <li>Become Glowfroge Certified by taking VPL's online <a href="https://www.vaughanpl.info/blogs/shareit/courses/glowforge-certification/" target="_blank">Glowforge Certification Course</a>. (If you've already participated in any VPL Glowforge program, the certification won't be required.) </li>
                    <li>Print and sign a <a href="/blogs/wp-content/uploads/sites/2/creation_spaces_customer_agreement.pdf" target="_blank">Customer Agreement Form</a> and return it on your first booking.</li>
                    <li>Read the rules and guidelines below:</li>
                    <ul>
                      <li>Bookings must be made at least 3 days in advance.</li>
                      <li>The laser cutter can be booked for a maximum 2-hour which 30 min of it is for preparation and cleaning.</li>
                      <li>Design can be in SVG, JPG, PNG, PDF or a simple drawing. The quality of the output is related to the resolution of the source.</li>
                    </ul>
                    <li>Request a booking in the form below:</li>
                </ul>
          </div>
          ...
          <form action="/blogs/shareit/bookings<?php if(!empty($choice)) echo '?choice=' . $choice; ?>" method="post" enctype="multipart/form-data" onsubmit="return validateBooking_service();">     
                <fieldset>
                  ...
                  <p><input name="booking_type_service" type="hidden" value="glowforge"></p>
                  ...
                  <p id="p_material"> <label for="lab_material_service" class="label_text">Material<sup>*</sup>:&nbsp;</label><br/>
                    <select name="lab_material_service" id="lab_material_service" required>
                      <option value="">-- Select Material --</option> 
                      <!--<option value="plywood_11x19_1x8" <?php echo ($lab_material == "plywood_11x19_1x8") ? "selected" : ""; ?>>Plywood (11x19 1/8in Thickness)</option>-->
                      <option value="plywood_11x19_1x4" <?php echo (empty($lab_material) || ($lab_material == "plywood_11x19_1x4")) ? "selected" : ""; ?>>Plywood (11x19 1/4in Thickness)</option>
                      <option value="Clear_Acrylic_8x12_1x8" <?php echo (empty($lab_material) || ($lab_material == "Clear_Acrylic_8x12_1x8")) ? "selected" : ""; ?>>Clear Acrylic (8x12 1/8in Thickness)</option>     
                      <option value="Clear_Acrylic_12x20_1x8" <?php echo (empty($lab_material) || ($lab_material == "Clear_Acrylic_12x20_1x8")) ? "selected" : ""; ?>>Clear Acrylic (12x20 1/8in Thickness)</option>                                        
                      <option value="use_my_own_material" <?php echo ($lab_material == "use_my_own_material") ? "selected" : ""; ?>>Use My Own Material</option>
                    </select>             
                  </p>

                  <p style="color: darkblue;"><strong>Please select either of two options below for submitting the design: </strong></p> 
                  <p id="p_carvey_link_field"> <label for="lab_carvey_link_service" class="label_text">Add Easel Editor Link:&nbsp;</label><br/>
                   <input type="text" name="lab_carvey_link_service" class="input_space" id="lab_carvey_link_service" value="<?php echo $lab_carvey_link; ?>" size="50" maxlength="150"/>
                  </p>
                  <p>Or</p>
                  <p id="p_lab_file"> <label for="lab_file_service" class="label_text">You can upload the image file (JPEG, PNG, PDF or SVG) (Max size: 2MB)&nbsp;</label> 
                    <br><input type="file" name="lab_file_service" class="input_space" id="lab_file_service">
                  </p>  
                  ...
                  <p class="text_center">
                  <input type="submit" name="submit_glowforge" id="submit_glowforge" value="Submit">
                  </p>                                    
              </fieldset>
            </form>
      ...
      <div id="formSix" style="display: none;">
        <div class="entry-content">
          <div class="description">
            <div>&nbsp;</div>
                <p>Masks are critically important, but can hide how we feel and what we look like. Our smile is an important tool for engaging with each other, especially with families who have special needs, such as those with Autism Spectrum Disorder. Just submit a headshot and have a free button made of your smiling face by visiting our Creation Space page and show your smile to the world! Limit 1 / person.</p>
                <div id="target-id8998" class="collapseomatic_content ">
          ...
          <form action="/blogs/shareit/bookings<?php if(!empty($choice)) echo '?choice=' . $choice; ?>" method="post" enctype="multipart/form-data" onsubmit="return validateBooking_service();">     
                <fieldset>
                  ...
                  <p><input name="booking_type_service" type="hidden" value="smilebutton"></p>
                    
                  <p> <label for="lab_branch_service" class="label_text">Branch<sup>*</sup>:&nbsp;</label></p>
                  <p> 
                      <select name="branch_service" title="Local Branch" id="branch_service" required>  <!-- onchange="changeLabs_service()" -->      
                          <option value="2"  <?php if($branch_service == "2") echo "selected"; ?>>Bathurst Clark Resource Library</option>                            
                          <option value="11" <?php if($branch_service == "11") echo "selected"; ?>>Civic Centre Resource Library</option>
                          <option value="7"  <?php if($branch_service == "7") echo "selected"; ?>>Pierre Berton Resource Library</option>
                      </select>
                  </p>             
                  ...
                  <p id="p_lab_file"> <label for="lab_file_service" class="label_text">You can upload the image file (JPEG, PNG, BMP or SVG) (Max size: 2MB)&nbsp;</label> 
                    <br><input type="file" name="lab_file_service" class="input_space" id="lab_file_service">
                  </p>  
                  ...
                  <p class="text_center">
                    <input type="submit" name="submit_smilebutton" id="submit_smilebutton" value="Submit">
                  </p>                                    
              </fieldset>
            </form>
...
<script type="text/javascript">
    ...
    function changeForms(default_lab)
    {
        ...
        var radioBtnGlowforge = document.getElementById("rb_glowforge");
        var radioBtnSmile = document.getElementById("rb_smilebutton");
        ...
        var booking_option = GetURLParameter('option');
       ...
       // sp.set('option',opt); 
        ...
        if (default_lab !== undefined || default_lab == '')
        {
          if (default_lab == "space" || booking_option == "sp")
          {
              radioBtnSpace.checked = true;
          }
          else if (default_lab == "equip" || booking_option == "eq")
          {
              radioBtnEquip.checked = true;
          }
          else if (default_lab == "3D_printer" || booking_option == "pr")
          {
              radioBtnPrinter.checked = true;
          }
          else if (default_lab == "carving" || booking_option == "cv")
          {
              radioBtnCarving.checked = true;
          }
          else if (default_lab == "glowforge" || booking_option == "gl")
          {
              radioBtnGlowforge.checked = true;
          }
          else if (default_lab == "smilebutton")
          {
              radioBtnSmile.checked = true;
          }
        }
        ...
        if (radioBtnSpace.checked){
          ...
          //jQuery('#lab_date_carving').data('Zebra_DatePicker').update();
        }
        else if(radioBtnGlowforge.checked){
          document.getElementById("formFive").style.display="block";
        }
        else if(radioBtnSmile.checked){
...
////////////////////////////////////////////////////////////////////////
      ...
      if (lab_time == "1100") 
      {
          if(reserved_times_array[i].date == lab_date && 
             ...
             (reserved_times_array[i].time == lab_time ||
              reserved_times_array[i].time == "11am" ||
  ...
  function limitTime_service(default_value)
  {
    ...
    var weekendTime = [{value: "10am", text: "10:00am - 11:00am"},
                       {value: "11am", text: "11:00am - 12:00pm"},
                       {value: "12pm", text: "12:00pm - 1:00pm"},
                       {value: "1pm",  text: " 1:00pm - 2:00pm"}]; 
    
    //For weekday 3D Printer
    var weekdayTime = [{value: "10am", text: "10:00am - 11:00am"},
                      {value: "11am", text: "11:00am - 12:00pm"},
                      {value: "12pm", text: "12:00pm - 1:00pm"},
                      {value: "1pm", text: " 1:00pm - 2:00pm"},
                      {value: "2pm", text: " 2:00pm - 3:00pm"},
                      {value: "3pm", text: " 3:00pm - 4:00pm"},
                      {value: "4pm", text: " 4:00pm - 5:00pm"},
                      {value: "5pm", text: " 5:00pm - 6:00pm"}];
  ...
  function limitTime_carving(default_value)
  {
     console.log(default_value);

     var datepicker = jQuery('#lab_date_carving').data('Zebra_DatePicker');
    ...
    //console.log(jQuery('#LabDate').val());   
    var chosen_date = jQuery('#lab_date_carving').val();
    ...
    //clear all options from the start time select box 
    var select_time_slot_erase = document.getElementById("lab_time_carving");
    var length = select_time_slot_erase.options.length;
    for (i = 0; i < length; i++) {
      select_time_slot_erase.options[0] = null;
    }

    var select_time_slot = document.getElementById("lab_time_carving");
    var branch_choice = jQuery("#branch_service");  
    var lab_name = "carvey"; 
    var option = "";
    var i = 0;
  ...
  function limitTime_space(default_value)
  {
    ...
    var recording_weekdayTime =  [{value: "10am", text: "10:00am - 1:00pm"},
                                  {value: "5pm",  text: " 2:00pm - 5:00pm"},
                                  {value: "6pm",  text: " 6:00pm - 8:00pm"}]; 

    var recording_Friday  =  [{value: "1pm", text: "10:00am - 1:00pm"},
                              {value: "2pm",  text: " 2:00pm - 4:00pm"}]; 

    var recording_weekendTime  =  [{value: "10am", text: "10:00am - 1:00pm"},
                                   {value: "2pm",  text: " 2:00pm - 4:00pm"}]; 


    var space_tue_thur_time = [{value: "1100", text: "11:00am - 2:00pm"},
                               {value: "1500", text: " 3:00pm - 6:00pm"},
                               {value: "1900", text: " 7:00pm - 8:00pm"}];

    var space_fri_sun_time = [{value: "1100", text: "11:00am - 2:00pm"},
                              {value: "1600", text: " 3:00pm - 4:00pm"}];
    ...
    if(chosen_date_obj >= new_times_date)
    {
      ...
      else if(lab_choice.val() == "recording")
      {
  ...
  function limitTime_equip(default_value){
      ...
      var pbrl_weekday_times =   [{value: "10am", text: "10:00am - 11:00am"},
                                  {value: "11am", text: "11:00am - 12:00pm"},
                                  {value: "12pm", text: "12:00pm - 1:00pm"},
                                  {value: "1pm", text: " 1:00pm - 2:00pm"},
                                  {value: "2pm", text: " 2:00pm - 3:00pm"},
      ...
      var pbrl_weekend_times = [{value: "10am", text: "10:00am - 11:00am"},
                                {value: "11am", text: "11:00am - 12:00pm"},
                                {value: "12pm", text: "12:00pm - 1:00pm"},
                                {value: "1pm",  text: " 1:00pm - 2:00pm"}];  
...
function addOrUpdateUrlParam(value)
{
...
<script type="text/javascript">
 ...
 jQuery('#lab_date_carving').Zebra_DatePicker({ 
    direction: [3, 27],
    disabled_dates:[
                      '24 12 2022', 
                      '25 12 2022',
