<?php
 /*
 Template Name: bookingglowforge
 */
   ...
   <div id="container" class="wrapper clear">
      <div class="primary">
         ...
         <?php while (have_posts()) : the_post(); ?>
            ...
            <?php get_template_part('calendar', 'bookingglowforge'); ?>
...
jQuery('#lab_file_service').change(function () { 
    ...
    if (cxc_individual_file == undefined) {
        ...
        if (allowedTypes.includes(cxc_individual_file.type) && cxc_individual_file.size <= maxSize) {
            ...
            alert('Please upload an image file (JPEG, PNG, PDF, or SVG) with a maximum size of 2MB.');
