...
<article id="post-<?php the_ID(); ?>" <?php post_class('blog-post'); ?>>
  <div class="entry-content" id="form-entry-div">
    ...
    <form action="/shareit/book-equipment<?php if(!empty($choice)) echo '?choice=' . $choice; ?>" method="post" enctype="multipart/form-data" onsubmit="return validateBooking();">			
				<fieldset>
          <p>Please complete all fields with an asterisk (*). </p>
					
						
          <p> <label for="branch">Branch<sup>*</sup>:&nbsp;</label> 
...
function changeLabs(default_lab){
    ...
    var clear_date = jQuery('#lab_date').val("");
